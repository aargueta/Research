...
input	[22:0]	dump_en; // Dump enable
output	[22:0]	ch_out; // Chains out
output	[22:0]	ch_out_vld; // Chains out Valid
output	[22:0]	ch_out_done; // Chains done
...
shadow_capture #(.DFF_BITS(736),.USE_DCLK(1),.CHAINS_IN(4),.CHAINS_OUT(23)) shadow_capture_sparc_exu_byp (
      .clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
      .dclk({{64{clk}}, {64{clk}}, {64{clk}}, {64{clk}}, {64{sehold_clk}}, {64{clk}}, {64{sehold_clk}}, {64{clk}}, {64{clk}}, {64{clk}}, {32{clk}}, {64{clk}}}), 
		.din({dfill_data_g2[63:0], rd_data_m[63:0], restore_rd_data[63:0], byp_irf_rd_data_w[63:0], byp_irf_rd_data_w[63:0], byp_irf_rd_data_w2[63:0], byp_irf_rd_data_w2[63:0], byp_alu_rs1_data_e[63:0], byp_alu_rs2_data_e[63:0], rs3_data_e[63:0], rs3h_data_e[31:0], byp_alu_rcc_data_e[63:0]}),
		.dump_en(dump_en), 
