...
wire [9:0] ch_dump_en;
   ...
   sparc_exu_rml_cwp cwp(
	...
	.c_en(c_en),   // [SHADOW]
	.dump_en(ch_dump_en[9:6]),   // [SHADOW]
	.ch_out(inst_ch_out[9:6]),   // [SHADOW]
	.ch_out_done(inst_ch_out_done[9:6]),    // [SHADOW]
	.ch_out_vld(inst_ch_out_vld[9:6]) // [SHADOW]
);
...
shadow_capture #(.DFF_BITS(85),.USE_DCLK(1),.CHAINS_IN(10),.CHAINS_OUT(8)) shadow_capture_sparc_exu_rml (
      .clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
      .dclk({clk, {2{clk}}, {2{clk}}, clk, clk, clk, clk, clk, clk, clk, clk, {3{clk}}, clk, clk, clk, clk, {3{clk}}, {3{clk}}, clk, {4{clk}}, clk, {3{clk}}, clk, {3{clk}}, clk, {3{clk}}, clk, {3{clk}}, clk, {3{clk}}, clk, {3{clk}}, clk, {3{clk}}, clk, {3{clk}}, {3{clk}}, {3{clk}}, {3{clk}}, {3{clk}}, {2{clk}}, {2{clk}}, {2{clk}}, {2{clk}}, {2{clk}}}), 
		.din({rml_reset_l, tid_d[1:0], tid_e[1:0], save_e, save_m, restore_e, win_trap_m, win_trap_w, spill_m, rml_ecl_kill_m, rml_ecl_other_e, rml_ecl_wtype_e[2:0], did_restore_m, did_restore_w, kill_restore_w, rml_cwp_wen_m, next_cwp_m[2:0], next_cwp_noreset_w[2:0], cwp_wen_nokill_w, exu_ifu_oddwin_s[3:0], cansave_wen_m, next_cansave_m[2:0], rml_cansave_wen_w, next_cansave_w[2:0], canrestore_wen_m, next_canrestore_m[2:0], rml_canrestore_wen_w, next_canrestore_w[2:0], otherwin_wen_m, next_otherwin_m[2:0], rml_otherwin_wen_w, next_otherwin_w[2:0], cleanwin_wen_m, next_cleanwin_m[2:0], rml_cleanwin_wen_w, next_cleanwin_w[2:0], rml_ecl_cansave_e[2:0], rml_ecl_canrestore_e[2:0], rml_ecl_otherwin_e[2:0], rml_ecl_cleanwin_e[2:0], agp_thr0[1:0], agp_thr0[1:0], agp_thr1[1:0], agp_thr2[1:0], agp_thr3[1:0]}),
		.dump_en(dump_en), 
