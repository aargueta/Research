...
shadow_capture #(.DFF_BITS(103),.USE_DCLK(1),.CHAINS_IN(1),.CHAINS_OUT(4)) shadow_capture_sparc_exu_rml_cwp (
      .clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
      .dclk({{3{clk}}, {3{clk}}, {3{clk}}, {3{clk}}, clk, clk, {15{clk}}, {15{clk}}, {15{clk}}, {15{clk}}, {4{clk}}, clk, {7{clk}}, {3{clk}}, {4{clk}}, {4{clk}}, clk, {5{clk}}}), 
		.din({cwp_thr0[2:0], cwp_thr1[2:0], cwp_thr2[2:0], cwp_thr3[2:0], full_swap_m, full_swap_w, {swap_slot0_state[1:0],swap_slot0_data[12:0]}, {swap_slot1_state[1:0],swap_slot1_data[12:0]}, {swap_slot2_state[1:0],swap_slot2_data[12:0]}, {swap_slot3_state[1:0],swap_slot3_data[12:0]}, swap_thr[3:0], just_swapped, {exu_tlu_spill,exu_tlu_spill_tid[1:0],exu_tlu_spill_other,exu_tlu_spill_wtype[2:0]}, spill_cwp[2:0], rml_ecl_swap_done[3:0], {exu_tlu_cwp_cmplt,exu_tlu_cwp_cmplt_tid[1:0],exu_tlu_cwp_retry}, cwp_fastcmplt_w, {cwpccr_update_w,tlu_exu_cwp_w[2:0],tlu_exu_cwp_retry_w}}),
		.dump_en(dump_en), 
