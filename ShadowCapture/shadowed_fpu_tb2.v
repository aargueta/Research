...
module shadowed_fpu_tb2;
	...
	initial begin
		...
		sh_rst= 1'b0;
		cluster_cken = 1;
		file = $fopen("fpu_tb2.log");
		forever begin
			#20 gclk = ~gclk;
			sh_clk = ~sh_clk;
			if(dump_en)begin
				$fdisplay(file, "%h", ch_out);
			end
			#20 gclk = ~gclk;
			sh_clk = ~sh_clk;
		end
	...
	initial begin
		...
		// 1.08333333333333325931846502499
		...
		#40 pcxPacketReady = 1'b0;
		// RETURN VALUE SHOULD BE 0x4008 0000 0000 0000
		// 3.0
//		
//		/*** FPU OP #3: FDIVd ***/
//		#280;
...
//		pcxCpuID = 3'b101;					// Random CPU ID
//		pcxThreadID = 2'b10; 				// Random Thread ID
//		pcxData = 64'h4059000000000000; 	// Float #1 = 100
//		fpuOpcode = 8'b01001110; 			// FDIVd
//		fpuConditionCode = 2'b00; 			// Not applicable (==)
//		fpuRoundMode = 2'b00;  				// Round to nearest
//		
//		pcxPacketReady = 1'b1;
...
//		pcxCpuID = 3'b101;					// Random CPU ID
//		pcxThreadID = 2'b10; 				// Random Thread ID
//		pcxData = 64'h4008000000000000; 	// Float #2 = 3.0
//		fpuOpcode = 8'b01001110; 			// FDIVd
//		fpuConditionCode = 2'b00; 			// Not applicable (==)
//		fpuRoundMode = 2'b00;  				// Round to nearest
//		
//		#40 pcxPacketReady = 1'b0;
//		// RETURN VALUE SHOULD BE 0x4040 AAAA AAAA AAAB
//		//  33.3333333333333357018091192003.
		...
		while(dump_done == 0)begin
			#40;
		end
		dump_en = 0;
		$fdisplay(file, "[DUMP #1 DONE]");
		
		
		
		/*** DUMP #2: ERROR INJECTION ***/
