...
*/
	...
	shadow_capture #(.DFF_BITS(103), .USE_DCLK(1), .CHAINS_IN(0), .CHAINS_OUT(1), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd103})) shadow_capture_tlu_hyperv (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({local_rst_l, thread_sel_id_m[`TLU_THRD_NUM-1:0], thread_sel_id_g[`TLU_THRD_NUM-1:0], thread_sel_id_w2[`TLU_THRD_NUM-1:0], thrid_e[1:0], thrid_m[1:0], thrid_g[1:0], local_flush_all_w2, htba_rw_e, hpstate_rw_e, htstate_rw_e, hintp_rw_e, htickcmp_rw_e, gl_rw_e, htba_rw_m, hpstate_rw_m, htstate_rw_m, hintp_rw_m, htickcmp_rw_m, gl_rw_m, gl_rw_g, hpstate_rw_g, htickcmp_rw_g, htba_rw_g, hintp_rw_g, htstate_rw_g, hpstate_rw_w2, gl_update_sel_w2[`TLU_THRD_NUM-1:0], dnrtry_inst_w2[`TLU_THRD_NUM-1:0], wsr_inst_w2, gl_lvl0_update_w2[`TSA_GLOBAL_WIDTH-1:0], gl_lvl0[1:0], agp_swap_w3, agp_new_w3[1:0], update_hpstate_w2[`TLU_THRD_NUM-1:0], htick_intdis0, htick_intdis1, htick_intdis2, htick_intdis3, {asi_queue_write_pq_m,asi_queue_read_pq_m}, {asi_queue_write_uf_g,asi_queue_read_g}, asi_queue_rw_m, asi_queue_rw_g, que_ill_va_g, asi_inrr_rw_m, asi_inrr_rw_g, asi_indr_rw_m, asi_indr_rw_g, asi_invr_rw_m, asi_invr_rw_g, cpu_mondo_head_rw_g, dev_mondo_head_rw_g, resum_err_head_rw_g, nresum_err_head_rw_g, cpu_mondo_tail_rw_g, dev_mondo_tail_rw_g, resum_err_tail_rw_g, nresum_err_tail_rw_g, cpu_mondo0_head[`TLU_ASI_QUE_WIDTH-1:0], cpu_mondo0_tail[`TLU_ASI_QUE_WIDTH-1:0], dev_mondo0_head[`TLU_ASI_QUE_WIDTH-1:0], dev_mondo0_tail[`TLU_ASI_QUE_WIDTH-1:0], resum_err0_head[`TLU_ASI_QUE_WIDTH-1:0], resum_err0_tail[`TLU_ASI_QUE_WIDTH-1:0], nresum_err0_head[`TLU_ASI_QUE_WIDTH-1:0], nresum_err0_tail[`TLU_ASI_QUE_WIDTH-1:0], cpu_mondo1_head[`TLU_ASI_QUE_WIDTH-1:0], cpu_mondo1_tail[`TLU_ASI_QUE_WIDTH-1:0], dev_mondo1_head[`TLU_ASI_QUE_WIDTH-1:0], dev_mondo1_tail[`TLU_ASI_QUE_WIDTH-1:0], resum_err1_head[`TLU_ASI_QUE_WIDTH-1:0], resum_err1_tail[`TLU_ASI_QUE_WIDTH-1:0], nresum_err1_head[`TLU_ASI_QUE_WIDTH-1:0], nresum_err1_tail[`TLU_ASI_QUE_WIDTH-1:0], cpu_mondo2_head[`TLU_ASI_QUE_WIDTH-1:0], cpu_mondo2_tail[`TLU_ASI_QUE_WIDTH-1:0], dev_mondo2_head[`TLU_ASI_QUE_WIDTH-1:0], dev_mondo2_tail[`TLU_ASI_QUE_WIDTH-1:0], resum_err2_head[`TLU_ASI_QUE_WIDTH-1:0], resum_err2_tail[`TLU_ASI_QUE_WIDTH-1:0], nresum_err2_head[`TLU_ASI_QUE_WIDTH-1:0], nresum_err2_tail[`TLU_ASI_QUE_WIDTH-1:0], cpu_mondo3_head[`TLU_ASI_QUE_WIDTH-1:0], cpu_mondo3_tail[`TLU_ASI_QUE_WIDTH-1:0], dev_mondo3_head[`TLU_ASI_QUE_WIDTH-1:0], dev_mondo3_tail[`TLU_ASI_QUE_WIDTH-1:0], resum_err3_head[`TLU_ASI_QUE_WIDTH-1:0], resum_err3_tail[`TLU_ASI_QUE_WIDTH-1:0], nresum_err3_head[`TLU_ASI_QUE_WIDTH-1:0], nresum_err3_tail[`TLU_ASI_QUE_WIDTH-1:0], {asi_hscpd_rw_m,asi_scpd_rw_m}, scpd_addr_va_g[`SCPD_ASI_VA_ADDR_WIDTH-1:0], scpd_ill_va_g, asi_scpd_rw_vld_g, asi_ld_addr_vld_g}),
		.dump_en(dump_en), 
		.chains_in(), 
		.chains_in_vld(), 
		.chains_in_done(), 
