...
// Some decode is done here since these signals are in the crit path
   ...
   sink #(2) s0(.in (sas_thrid_w));
	...
	shadow_capture #(.DFF_BITS(275), .USE_DCLK(1), .CHAINS_IN(1), .CHAINS_OUT(1), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd275})) shadow_capture_sparc_ifu_fcl (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({fcl_reset_l, itlb_addr_real_l, xlate_en_d1, pstate_am_d1, tlzero_vec_d1[3:0], cam_vld_f, cam_vld_s1, tlb_invall_f, itlb_access_done, itlb_rd_req_f, itlb_write_done, itlb_rd_access_done_d1, itlb_rd_access_done_d2, fcl_erb_asi_tid_f, itlb_data_rd_f, itlb_data_rd_s, icache_en_d1, icache_on_f, icache_on_s1, rdreq_f, rdreq_s1, usenir_f, usenir_s1, inst_vld_f, stall_s1, tinst_vld_s, inst_vld_d, inst_vld_d_crit, inst_vld_e, inst_vld_m, inst_vld_w, inst_vld_w_crit, flush_sonly_m, ims_flush_sonly_m, ims_flush_sonly_w, flush_pipe_w2, canthr_s_early, late_flush_w2, forcemiss_s1, ifu_tlu_icmiss_e, tlb_cam_miss_s1, tlbmiss_d, immu_miss_e, immu_miss_m, nir_tlbmiss_vec, fcl_fdp_addr_mask_d, pc_oor_s1, priv_mode_s1, hpriv_mode_s1, hpriv_mode_w2, inst_acc_vec_d, inst_acc_exc_e, priv_violtn_m, nir_privvec, inst_vld_d1, ifet_ue_vec_e, fcl_dtu_tlzero_d, trap_m, no_iftrap_w, ifu_tlu_ttype_m[8:0], async_rst_i4, {lsu_stallreq_d1,
ffu_stallreq_d1}, rst_stallreq_d1, rst_stallreq_d2, arst_vld_s, spu_tid_w2, rstint_i3, resumint_i3, nuke_thr_i3, sftint_i3, hintp_i3, rerr_i3, hwint_i4, spuint0_i3, spuint1_i3, ceint_i3, ueint_i3, supv_int_en_d1, hypv_int_en_d1, intr_pending_s, any_intr_vec_s, intr_vld_d, intr_vld_e, intr_vld_m, intr_vld_w, rst_thr_w, resum_thr_w, nuke_thr_w, ueint_m, ueint_trap_w, hintp_m, hwint_m, spuint1_m, spuint1_trap_w, spuint0_m, spuint0_trap_w, sftint_m, ceint_m, ceint_trap_w, rerr_m, rb_intr_w, delay_slot_vec, va2_f, thr_usen_bf, switch_s2, tm_fd_l, thr_f_flop, thr_s1, thr_d, thr_e, thr_e_v2, thr_m, thr_w, same_thr_mw2, thr_w2, rb2_inst_e, rt2_inst_e, rb1_inst_d, rt1_inst_d, rb0_inst_s, rt0_inst_s, retract_iferr_e, brtaken_m, {trappc_vld_w2,
trapnpc_vld_w2}, trap_tid_w2[1:0], irf_ce_w, {mark4rb_w,
mark4rb_m}, utrap_flush_w, {ce_cnt1,ce_cnt0}, disable_ce_e, ntpc_vld, rdsr_sel_pc_e, rdsr_sel_thr_e, fcl_imd_oddwin_d}),
		.dump_en(dump_en), 
