...
lsu_tlbdp tlbdp (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[20]),   // [SHADOW]
		.ch_out(inst_ch_out[20]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[20]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[20]) // [SHADOW]
);
...
lsu_tagdp tagdp (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[19]),   // [SHADOW]
		.ch_out(inst_ch_out[19]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[19]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[19]) // [SHADOW]
);
...
lsu_stb_rwctl stb_rwctl (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[17]),   // [SHADOW]
		.ch_out(inst_ch_out[17]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[17]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[17]) // [SHADOW]
);
`else
...
lsu_stb_rwdp  stb_rwdp  (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[18]),   // [SHADOW]
		.ch_out(inst_ch_out[18]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[18]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[18]) // [SHADOW]
); // Templated
/*
...
lsu_stb_ctl stb_ctl0  (
                       ...
                       .lsu_outstanding_rmo_st_max(lsu_outstanding_rmo_st_max[0]),
		.sh_clk(sh_clk),   // [SHADOW]
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[13]),   // [SHADOW]
		.ch_out(inst_ch_out[13]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[13]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[13]) // [SHADOW]
); // Templated
lsu_stb_ctldp stb_ctldp0  (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[21]),   // [SHADOW]
		.ch_out(inst_ch_out[21]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[21]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[21]) // [SHADOW]
);
...
lsu_stb_ctl stb_ctl1  (
                       ...
                       .lsu_outstanding_rmo_st_max(1'b0),
		.sh_clk(sh_clk),   // [SHADOW]
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[15]),   // [SHADOW]
		.ch_out(inst_ch_out[15]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[15]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[15]) // [SHADOW]
); // Templated
lsu_stb_ctldp stb_ctldp1  (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[22]),   // [SHADOW]
		.ch_out(inst_ch_out[22]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[22]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[22]) // [SHADOW]
);
   ...
   lsu_stb_ctl stb_ctl2  (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[14]),   // [SHADOW]
		.ch_out(inst_ch_out[14]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[14]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[14]) // [SHADOW]
); // Templated
lsu_stb_ctldp stb_ctldp2  (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[23]),   // [SHADOW]
		.ch_out(inst_ch_out[23]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[23]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[23]) // [SHADOW]
);
   ...
   lsu_stb_ctl stb_ctl3  (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[16]),   // [SHADOW]
		.ch_out(inst_ch_out[16]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[16]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[16]) // [SHADOW]
); // Templated
lsu_stb_ctldp stb_ctldp3  (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[24]),   // [SHADOW]
		.ch_out(inst_ch_out[24]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[24]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[24]) // [SHADOW]
);
`else // !`ifdef FPGA_SYN_1THREAD
...
lsu_qdp1  qdp1  (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[10:9]),   // [SHADOW]
		.ch_out(inst_ch_out[10:9]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[10:9]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[10:9]) // [SHADOW]
); // Templated
`else
...
lsu_qdp2 qdp2  (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[12:11]),   // [SHADOW]
		.ch_out(inst_ch_out[12:11]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[12:11]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[12:11]) // [SHADOW]
);
