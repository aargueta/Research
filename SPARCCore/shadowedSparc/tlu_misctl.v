...
*/
	...
	shadow_capture #(.DFF_BITS(350), .USE_DCLK(1), .CHAINS_IN(0), .CHAINS_OUT(1), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd350})) shadow_capture_tlu_misctl (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({tsa0_ccr_m[`TSA_CCR_WIDTH-1:0], tsa0_cwp_m[`TSA_CWP_WIDTH-1:0], tsa0_asi_m[`TLU_ASI_STATE_WIDTH-1:0], tsa0_pstate_m[`TSA_PSTATE_WIDTH-1:0], tsa0_gl_m[`TSA_GLOBAL_WIDTH-1:0], tsa0_pc_m[46:0], tsa1_ttype_m[`TSA_TTYPE_WIDTH-1:0], tsa1_htstate_m[`TSA_HTSTATE_WIDTH-1:0], tsa1_npc_m[46:0], thrd_sel_m[`TLU_THRD_NUM-1:0], tsa_rd_vld_m, sscan_tt0_data[`TSA_TTYPE_WIDTH-1:0], sscan_tt1_data[`TSA_TTYPE_WIDTH-1:0], sscan_tt2_data[`TSA_TTYPE_WIDTH-1:0], sscan_tt3_data[`TSA_TTYPE_WIDTH-1:0], trap_pc_w2[48:0], trap_npc_w2[48:0], tsa0_pc_w[46:0], ifu_pc_w[48:0], tsa1_npc_w[46:0], tlu_pic_onebelow_m, tlu_pic_twobelow_m}),
		.dump_en(dump_en), 
		.chains_in(), 
		.chains_in_vld(), 
		.chains_in_done(), 
