...
tlu_tdp tdp (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[13:12]),   // [SHADOW]
		.ch_out(inst_ch_out[13:12]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[13:12]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[13:12]) // [SHADOW]
);
...
tlu_mmu_dp mmu_dp (
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[9:8]),   // [SHADOW]
		.ch_out(inst_ch_out[9:8]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[9:8]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[9:8]) // [SHADOW]
);
        //   .rst_l		(tlu_rst_l));
