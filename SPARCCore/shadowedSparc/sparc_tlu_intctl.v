...
module sparc_tlu_intctl(/*AUTOARG*/
   ...
   tlu_asi_queue_rd_vld_g, tlu_va_ill_g
,
...
//
   ...
   assign  inc_indr_req_thrid[0] = indr_grant[3] | indr_grant[1];
	...
	shadow_capture #(.DFF_BITS(27), .USE_DCLK(1), .CHAINS_IN(1), .CHAINS_OUT(1), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd27})) shadow_capture_sparc_tlu_intctl (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({local_rst_l, tlu_ifu_rstint_i2, tlu_ifu_nukeint_i2, tlu_ifu_resumint_i2, tlu_ifu_hwint_i3[3:0], tlu_ifu_rstthr_i2[3:0], int_tlu_asi_data_vld_w2, int_ld_ill_va_w2, indr_vld[3:0], indr_req_valid_disable, indr_req_vec[3:0], int_tlu_longop_done[3:0]}),
		.dump_en(dump_en), 
