...
dff_s  #(64) stgg_eldxa (
	...
	shadow_capture #(.DFF_BITS(912), .USE_DCLK(1), .CHAINS_IN(0), .CHAINS_OUT(2), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd912})) shadow_capture_tlu_mmu_dp (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({rst_l, pc_g[47:13], ldst_va_m[47:0], ldst_va_g[47:0], tlb_dmp_va_g[47:13], {tlb_dmp_va_d1[47:13],tlu_dmp_key_vld_d1[4:0]}, idtlb_dmp_key_pend[40:0], tag_access_ctxt_g[12:0], ptr_ctxt_cfg[5:0], tlu_tsb_base_w2_d1[47:13], {idtte_tag_vld_d1,idtte_tag_lock_d1,tlu_tte_tag_d1[2:0],
tlu_tte_wr_pid_d1[2:0],tlu_tte_real_d1,tlu_tlb_tag_invrt_parity_d1}, {idtte_tag_b58t55_w2[58:55],idtte_tag_b53t0_w2[53:0]}, idtte_data_w2[41:0], tlu_tlb_tag_invrt_parity_d2, tlu_tlb_data_invrt_parity_d1, {parity_tag_d1,parity_data_d1}, dsfar0[47:0], dsfar1[47:0], dsfar2[47:0], dsfar3[47:0], dsfsr0[23:1], dsfsr0[0], dsfsr1[23:1], dsfsr1[0], dsfsr2[23:1], dsfsr2[0], dsfsr3[23:1], dsfsr3[0], isfsr0[23:1], isfsr0[0], isfsr1[23:1], isfsr1[0], isfsr2[23:1], isfsr2[0], isfsr3[23:1], isfsr3[0], ldxa_l1mx1_dout_m[47:0], lsu_exu_ldxa_data_g[63:0]}),
		.dump_en(dump_en), 
		.chains_in(), 
		.chains_in_vld(), 
		.chains_in_done(), 
