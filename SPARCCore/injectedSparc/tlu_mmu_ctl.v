...
dff_s #(4) err_inj (
	...
	shadow_capture #(.DFF_BITS(270), .USE_DCLK(1), .CHAINS_IN(0), .CHAINS_OUT(1), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd270})) shadow_capture_tlu_mmu_ctl (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({rst_l, ifu_tlu_flush_w, inst_vld_g, {priority_squash_g,trp_vld_g}, thrid_d[1:0], thrid_e[1:0], {ld_inst_m,st_inst_m,thrid_m[1:0],alt_space_m}, {ld_inst_unflushed,st_inst_unflushed,thrid_g[1:0],alt_space_g,immu_miss_g}, ldxa_l1mx1_sel_out[2:0], sehold_out, idside_nzctxt_accwr_early_g, itacc_nctxt0, dtacc_nctxt0, itacc_nctxt1, dtacc_nctxt1, itacc_nctxt2, dtacc_nctxt2, itacc_nctxt3, dtacc_nctxt3, dmmu_async_supported_asi, immu_async_supported_asi, asi_reg0_d1[7:0], asi_reg1_d1[7:0], asi_reg2_d1[7:0], asi_reg3_d1[7:0], asi_state_e[7:0], early_va_m[7:0], {memref_e,thread0_e,thread1_e,thread2_e,thread3_e,alt_space_e}, memref_m, {dmmu_8k_ptr_m,dmmu_64k_ptr_m,dmmu_direct_ptr_m,
dmmu_decode_asi58_m,immu_decode_asi50_m,
dmmu_zctxt_ps0_tsb_m,dmmu_zctxt_ps1_tsb_m,
dmmu_nzctxt_ps0_tsb_m,dmmu_nzctxt_ps1_tsb_m,
dmmu_zctxt_cfg_m,dmmu_nzctxt_cfg_m,
...
immu_nzctxt_ps0_tsb_m,immu_nzctxt_ps1_tsb_m,
immu_zctxt_cfg_m,immu_nzctxt_cfg_m,
immu_8k_ptr_m,immu_64k_ptr_m}, dmmu_sync_supported_asi_m, immu_sync_supported_asi_m, {immu_sync_illgl_va_g,dmmu_sync_illgl_va_g}, {dmmu_tag_access_en,
dmmu_sync_fsr_en,dmmu_sync_far_en,
dmmu_zctxt_ps0_tsb_en,dmmu_zctxt_ps1_tsb_en,
dmmu_nzctxt_ps0_tsb_en,dmmu_nzctxt_ps1_tsb_en,
dmmu_zctxt_cfg_en,dmmu_nzctxt_cfg_en,
...
immu_zctxt_ps0_tsb_en,immu_zctxt_ps1_tsb_en,
immu_nzctxt_ps0_tsb_en,immu_nzctxt_ps1_tsb_en,
immu_zctxt_cfg_en,immu_nzctxt_cfg_en}, lng_ltncy_en_d1, {tlb_ldst_va_g[10:3],tlb_access_tid_g[1:0]}, {dmmu_data_in_en,dmmu_data_access_en,dmmu_tag_read_en,
dmmu_demap_en,dmmu_invalidate_all_en,
tlb_ld_inst_unflushed,tlb_st_inst_unflushed}, dtlb_rw_index_vld_pend, dtlb_rw_index_pend[5:0], tlb_rd_mode_d1, dtlb_done_d1, itlb_done_d1, {dtlb_dmp_all_pend,dtlb_dmp_pctxt_pend,dtlb_dmp_sctxt_pend,
dtlb_dmp_nctxt_pend,dmmu_inv_all_pend}, {tlu_lsu_ldxa_tid_w2[1:0],tlu_lsu_stxa_ack_tid[1:0]}, {tlu_dtlb_dmp_all_g,tlu_dtlb_dmp_pctxt_g,
tlu_dtlb_dmp_sctxt_g,tlu_dtlb_dmp_nctxt_g,tlu_dtlb_dmp_actxt_g}, {immu_data_in_en,immu_data_access_en,immu_tag_read_en,immu_demap_en,immu_invalidate_all_en}, itlb_rw_index_vld_pend, {itlb_dmp_by_ctxt_pend,itlb_dmp_all_pend,immu_inv_all_pend}, tlu_itlb_dmp_actxt_g, tlb_access_en_l_d1, {itlb_wr_pend,itlb_data_rd_pend,itlb_tag_rd_pend,
dtlb_wr_pend,dtlb_data_rd_pend,dtlb_tag_rd_pend,
idemap_pend,ddemap_pend}, {dtlb_dmp_vld_d1,itlb_dmp_vld_d1}, tlu_lsu_stxa_ack, tlb_admp_mode, tlb_admp_mode_d1, tlb_write_mode, tlu_lsu_ldxa_async_data_vld, mtest_rdps0_sel, tsb_size_d1[3:0], tsb_split_d1, ps1_d1, va_d1[23:0], , dptr0_pg64k_vld, dptr1_pg64k_vld, dptr2_pg64k_vld, dptr3_pg64k_vld, zctxt_cfg0_ps1[2:0], nzctxt_cfg0_ps1[2:0], zctxt_cfg1_ps1[2:0], nzctxt_cfg1_ps1[2:0], zctxt_cfg2_ps1[2:0], nzctxt_cfg2_ps1[2:0], zctxt_cfg3_ps1[2:0], nzctxt_cfg3_ps1[2:0], nucleus_ctxt_g, thread_tl_zero_m, pstate_am_m, lsu_ifu_inj_ack[3:0]}),
		.dump_en(dump_en), 
		.chains_in(), 
		.chains_in_vld(), 
		.chains_in_done(), 
