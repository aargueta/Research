...
dff_s #(`TLU_ASR_DATA_WIDTH) dff_tlu_exu_rsr_data_m (
	...
	shadow_capture #(.DFF_BITS(771), .USE_DCLK(1), .CHAINS_IN(0), .CHAINS_OUT(2), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd771})) shadow_capture_tlu_tdp (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({tlu_cwp0[2:0], tlu_cwp1[2:0], tlu_cwp2[2:0], tlu_cwp3[2:0], trap_cwp0[2:0], trap_cwp1[2:0], trap_cwp2[2:0], trap_cwp3[2:0], imm_asi_e[`TLU_ASI_STATE_WIDTH-1:0], imm_asi_vld_e, wsr_data_w2[47:0], sftint0[14:1], sftint0[`SFTINT_TICK_CMP], sftint0[`SFTINT_PIB_WRAP], sftint0[`SFTINT_STICK_CMP], sftint1[14:1], sftint1[`SFTINT_TICK_CMP], sftint1[`SFTINT_PIB_WRAP], sftint1[`SFTINT_STICK_CMP], sftint2[14:1], sftint2[`SFTINT_TICK_CMP], sftint2[`SFTINT_PIB_WRAP], sftint2[`SFTINT_STICK_CMP], sftint3[14:1], sftint3[`SFTINT_TICK_CMP], sftint3[`SFTINT_PIB_WRAP], sftint3[`SFTINT_STICK_CMP], true_tba0[32:0], true_tba1[32:0], true_tba2[32:0], true_tba3[32:0], true_htba0[`TLU_HTBA_WIDTH-1:0], true_htba1[`TLU_HTBA_WIDTH-1:0], true_htba2[`TLU_HTBA_WIDTH-1:0], true_htba3[`TLU_HTBA_WIDTH-1:0], true_tick[60:0], true_tickcmp0[`TICKCMP_INTDIS], true_tickcmp0[`TLU_ASR_DATA_WIDTH-2:0], true_tickcmp1[`TICKCMP_INTDIS], true_tickcmp1[`TLU_ASR_DATA_WIDTH-2:0], true_tickcmp2[`TICKCMP_INTDIS], true_tickcmp2[`TLU_ASR_DATA_WIDTH-2:0], true_tickcmp3[`TICKCMP_INTDIS], true_tickcmp3[`TLU_ASR_DATA_WIDTH-2:0], true_stickcmp0[`TICKCMP_INTDIS], true_stickcmp0[`TLU_ASR_DATA_WIDTH-2:0], true_stickcmp1[`TICKCMP_INTDIS], true_stickcmp1[`TLU_ASR_DATA_WIDTH-2:0], true_stickcmp2[`TICKCMP_INTDIS], true_stickcmp2[`TLU_ASR_DATA_WIDTH-2:0], true_stickcmp3[`TICKCMP_INTDIS], true_stickcmp3[`TLU_ASR_DATA_WIDTH-2:0], true_htickcmp0[`TLU_ASR_DATA_WIDTH-2:0], true_htickcmp1[`TLU_ASR_DATA_WIDTH-2:0], true_htickcmp2[`TLU_ASR_DATA_WIDTH-2:0], true_htickcmp3[`TLU_ASR_DATA_WIDTH-2:0], tlu_hintp[0], tlu_hintp[1], tlu_hintp[2], tlu_hintp[3], dnrtry_pstate_m[`WSR_PSTATE_VR_WIDTH-1:0], dnrtry_pstate_g[`WSR_PSTATE_VR_WIDTH-1:0], dnrtry_pstate_w2[`WSR_PSTATE_VR_WIDTH-1:0], tsa_dnrtry_hpstate_m[`TSA_HTSTATE_WIDTH-1:0], tsa_dnrtry_hpstate_g[`TSA_HTSTATE_WIDTH-1:0], tsa_dnrtry_hpstate_w2[`TSA_HTSTATE_WIDTH-1:0], dnrtry_global_m[`TSA_GLOBAL_WIDTH-1:0], tlu_dnrtry_global_g[`TSA_GLOBAL_WIDTH-1:0], true_pc0[48:0], true_npc0[48:0], true_pc1[48:0], true_npc1[48:0], true_pc2[48:0], true_npc2[48:0], true_pc3[48:0], true_npc3[48:0], {restore_pstate0_w3[`WSR_PSTATE_VRANGE2_HI:`WSR_PSTATE_VRANGE1_HI-1],
restore_pstate0_w3[`WSR_PSTATE_VRANGE1_LO]}, restore_pstate0_w3[`WSR_PSTATE_VR_PRIV], true_hpstate0[`TLU_HPSTATE_WIDTH-1:`TLU_HPSTATE_WIDTH-2], {true_hpstate0[`HPSTATE_RED],
true_hpstate0[`HPSTATE_TLZ]}, true_hpstate0[`HPSTATE_PRIV], tlu_exu_rsr_data_m[`TLU_ASR_DATA_WIDTH-1:0]}),
		.dump_en(dump_en), 
		.chains_in(), 
		.chains_in_vld(), 
		.chains_in_done(), 
