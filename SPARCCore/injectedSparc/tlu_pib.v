...
//
	...
	shadow_capture #(.DFF_BITS(53), .USE_DCLK(1), .CHAINS_IN(0), .CHAINS_OUT(1), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd53})) shadow_capture_tlu_pib (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({local_rst_l, tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-1:0], pib_sraddr_e[`TLU_ASR_ADDR_WIDTH-1:0], tlu_rsr_inst_e, pcr_rw_m, pic_priv_rw_m, pic_npriv_rw_m, imiss_m, pcr_rw_g, pic_priv_rw_g, pic_npriv_rw_g, imiss_g, immu_miss_g, pcr0[`PIB_PCR_WIDTH-3:0], pcr0[`PIB_PCR_CL_OVF], pcr0[`PIB_PCR_CH_OVF], pcr1[`PIB_PCR_WIDTH-3:0], pcr1[`PIB_PCR_CL_OVF], pcr1[`PIB_PCR_CH_OVF], pcr2[`PIB_PCR_WIDTH-3:0], pcr2[`PIB_PCR_CL_OVF], pcr2[`PIB_PCR_CH_OVF], pcr3[`PIB_PCR_WIDTH-3:0], pcr3[`PIB_PCR_CL_OVF], pcr3[`PIB_PCR_CH_OVF], pic_cnt_en_w2[`TLU_THRD_NUM-1:0], pic_update_sel_ctr[1:0], incr_evq[`TLU_THRD_NUM-1:0], picl_evq0[`PIB_EVQ_CNT_WIDTH-1:0], picl_evq1[`PIB_EVQ_CNT_WIDTH-1:0], picl_evq2[`PIB_EVQ_CNT_WIDTH-1:0], picl_evq3[`PIB_EVQ_CNT_WIDTH-1:0], picl_cnt0[`PIB_PIC_CNT_WIDTH-1:0], picl_cnt1[`PIB_PIC_CNT_WIDTH-1:0], picl_cnt2[`PIB_PIC_CNT_WIDTH-1:0], picl_cnt3[`PIB_PIC_CNT_WIDTH-1:0], inst_vld_w2[`TLU_THRD_NUM-1:0], tcc_inst_w2, pich_fourbelow_flg[`TLU_THRD_NUM-1:0], pich_cnt0[`PIB_PIC_CNT_WIDTH-1:0], pich_cnt1[`PIB_PIC_CNT_WIDTH-1:0], pich_cnt2[`PIB_PIC_CNT_WIDTH-1:0], pich_cnt3[`PIB_PIC_CNT_WIDTH-1:0], thread_rsel_e[`TLU_THRD_NUM-2:0], picl_cnt_wrap[0], pich_cnt_wrap[0], picl_cnt_wrap[1], pich_cnt_wrap[1], picl_cnt_wrap[2], pich_cnt_wrap[2], picl_cnt_wrap[3], pich_cnt_wrap[3]}),
		.dump_en(dump_en), 
		.chains_in(), 
		.chains_in_vld(), 
		.chains_in_done(), 
