...
`endif
   assign        byp_irf_rd_data_w2[71:64] = ~rd_synd_w2_l[7:0];
	...
	shadow_capture #(.DFF_BITS(608), .USE_DCLK(1), .CHAINS_IN(2), .CHAINS_OUT(2), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd608})) shadow_capture_sparc_exu_byp (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({dfill_data_g2[63:0], rd_data_m[63:0], restore_rd_data[63:0], byp_irf_rd_data_w[63:0], byp_irf_rd_data_w2[63:0], byp_alu_rs1_data_e[63:0], byp_alu_rs2_data_e[63:0], rs3_data_e[63:0], rs3h_data_e[31:0], byp_alu_rcc_data_e[63:0]}),
		.dump_en(dump_en), 
