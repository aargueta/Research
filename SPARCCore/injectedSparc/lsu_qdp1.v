...
//====================================================================   
	...
	shadow_capture #(.DFF_BITS(731), .USE_DCLK(1), .CHAINS_IN(0), .CHAINS_OUT(2), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd731})) shadow_capture_lsu_qdp1 (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({ldst_va_g[12:0], lmq0_pcx_pkt_tmp[`LMQ_VLD:0], {dtag_wr_parity_7_0_m,dtag_wr_parity_15_8_m,
dtag_wr_parity_23_16_m,dtag_wr_parity_28_24_m,
lsu_dfq_ld_vld_m,dtag_wr_parity_28_24_with_invrt_m}, dtag_wdata_m[28:0], st_rs3_data_m[63:0], st_rs3_data_g[63:0], lmq0_bypass_data[63:0], tlb_st_data_d1[63:0], lsu_ifu_stxa_data[47:0], cache_rdata_w2[63:0], spu_lsu_ldst_pckt_d1[`PCX_WIDTH-1:0], spc_pcx_data_pa[`PCX_WIDTH-1:0], {lsu_ifu_ld_icache_index[11:5],lsu_ifu_ld_pcxpkt_tid[1:0]}, va_wtchpt0_addr[47:3], va_wtchpt1_addr[47:3], va_wtchpt2_addr[47:3], va_wtchpt3_addr[47:3]}),
		.dump_en(dump_en), 
		.chains_in(), 
		.chains_in_vld(), 
		.chains_in_done(), 
