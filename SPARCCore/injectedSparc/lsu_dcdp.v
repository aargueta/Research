...
assign	lsu_ffu_ld_data[63:0] = align_byte[63:0] ;
	...
	shadow_capture #(.DFF_BITS(90), .USE_DCLK(1), .CHAINS_IN(0), .CHAINS_OUT(1), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd90})) shadow_capture_lsu_dcdp (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({{ld_data_msb_w0_g[7:0],ld_data_msb_w1_g[7:0],ld_data_msb_w2_g[7:0],ld_data_msb_w3_g[7:0]}, {dcache_alt_rsel_way_m[3:0],dcache_alt_mx_sel_m}, {dcache_alt_rsel_way_g[3:0],dcache_alt_mx_sel_g}, {signed_ldst_byte_g,signed_ldst_hw_g,signed_ldst_w_g}, morphed_addr_g[7:0], {
merge7_sel_byte0,merge7_sel_byte7,
merge6_sel_byte1,merge6_sel_byte6,
merge5_sel_byte2,merge5_sel_byte5,
merge4_sel_byte3,merge4_sel_byte4,
