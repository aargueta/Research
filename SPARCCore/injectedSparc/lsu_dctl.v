...
dff_s #(5)  lmq_byp_misc_stgm (
	...
	shadow_capture #(.DFF_BITS(667), .USE_DCLK(1), .CHAINS_IN(1), .CHAINS_OUT(2), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd667})) shadow_capture_lsu_dctl (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({dbb_reset_l, {lsu_bist_wvld_e,lsu_bist_rvld_e}, memref_e, lsu_sscan_data[14:13], lsu_inst_vld_w, {ifu_lsu_flush_w,ifu_tlu_flush_fd_w_q,ifu_tlu_flush_fd2_w_q,ifu_tlu_flush_fd3_w_q}, alt_space_e, {altspace_ldst_m,non_altspace_ldst_m}, {altspace_ldst_g,non_altspace_ldst_g}, tl_zero_d1[3:0], thread_tl_zero_m, pstate_am[3:0], local_dtlb_wr_vld_g, {dtlb_wr_vld_d1,dtlb_tag_rd_d1,dtlb_data_rd_d1,dtlb_dmp_vld_d1,
dtlb_inv_all_d1}, tlbop_init_d1, tlbop_init_d2, tlbop_init_d3, tlbop_init_d4, tlbop_init_d5, {dtlb_done_d1,tag_rd_vld_m,data_rd_vld_m}, dtlb_inv_all_m, {dtlb_done_d2,tag_rd_vld_g,data_rd_vld_g}, {lsu_sraddr_e[6:0],lsu_wsr_inst_e}, {asi_state_wr_en_m,lsu_alt_space_m}, {asi_state_wr_en,lsu_alt_space_g}, {tlu_lsu_asi_update_g,tlu_lsu_tid_g[1:0]}, {sta_internal_m,lda_internal_m}, {stxa_internal,ldxa_internal}, lsu_asi_state[7:0], {dtlb_bypass_m,dcache_enable_m}, {lsu_dtlb_bypass_g,dcache_enable_g}, iob_fwdpkt_vld, {dcache_iob_wr_e,dcache_iob_rd_e}, {bist_tap_wr_en}, {mrgn_tap_wr_en}, {dfture_tap_rd_d1[3:0],dfture_tap_wr_en[3:0]}, {bistctl_va_vld,bistctl_state_en}, {mrgnctl_va_vld,mrgnctl_state_en}, {ldiagctl_va_vld,ldiagctl_state_en}, lsu_asi_rd_en_w2, {ldxa_tlbrd3_w3,ldxa_tlbrd2_w3,
ldxa_tlbrd1_w3,ldxa_tlbrd0_w3}, lsu_asi_illgl_va_cmplt_w2[3:0], dtag_rsel_hold[3:0], {ld_inst_vld_m,st_inst_vld_m,ldst_sz_m[1:0],
ld_rd_m[4:0],fp_ldst_m}, dcache_arry_data_sel_m, {ld_inst_vld_unflushed,st_inst_vld_unflushed,ldst_sz_g[1:0],
ld_rd_g[4:0],fp_ldst_g}, tlb_cam_hit_mod, lsu_nceen_d1[3:0], nceen_pipe_g, dtlb_perror_en_w2, dtlb_perror_en_w3, pref_inst_m, pref_inst_g, lsu_exu_dfill_vld_w2, {cpx_ld_err_m[1:0],bld_cnt_max_g}, bld_err[1:0], bld_helper_cmplt_g, {bld_squash_err_w2,bld_unc_err_pend_w2,bld_corr_err_pend_w2}, {stb_cam_hit_w2,fld_vld_sync_no_camhit_w2,fld_vld_async_w2}, dfq_tid_m[1:0], dfq_tid_g[1:0], pref_tlbmiss_cmplt_d1[3:0], pref_tlbmiss_cmplt_d2[3:0], {ldst_cmplt_late_3_d1,ldst_cmplt_late_2_d1,
ldst_cmplt_late_1_d1,ldst_cmplt_late_0_d1}, {ldxa_internal_swo_g,asi_internal_ld_g}, lsu_ifu_dc_parity_error_w2_q, ld_inst_vld_no_flush_w2, lsu_exu_ldst_miss_w2_tmp, strm_asi, dtlb_wr_init_d1, dtlb_wr_init_d2, dtlb_wr_init_d3, dtlb_wr_init_d4, {stxa_stall_wr_cmplt3_d1,stxa_stall_wr_cmplt2_d1,
stxa_stall_wr_cmplt1_d1,stxa_stall_wr_cmplt0_d1}, {tlb_access_en0_tmp,tlb_access_en1_tmp,tlb_access_en2_tmp,tlb_access_en3_tmp}, {tlb_access_en0_unflushed,tlb_access_en1_unflushed,tlb_access_en2_unflushed,tlb_access_en3_unflushed}, {tlb_ld_inst0,tlb_st_inst0}, {dc0_diagnstc_asi,dtagv0_diagnstc_asi,ifu_nontlb0_asi}, {tlb_ld_inst1,tlb_st_inst1}, {dc1_diagnstc_asi,dtagv1_diagnstc_asi,ifu_nontlb1_asi}, {tlb_ld_inst2,tlb_st_inst2}, {dc2_diagnstc_asi,dtagv2_diagnstc_asi,ifu_nontlb2_asi}, {tlb_ld_inst3,tlb_st_inst3}, {dc3_diagnstc_asi,dtagv3_diagnstc_asi,ifu_nontlb3_asi}, asi_fifo0_q[1:0], asi_fifo0_vld, asi_fifo1_q[1:0], asi_fifo1_vld, asi_fifo2_q[1:0], asi_fifo2_vld, asi_fifo3_q[1:0], asi_fifo3_vld, tlb_access_pending, {tlb_access_sel_thrd3_d1,tlb_access_sel_thrd2_d1,
tlb_access_sel_thrd1_d1,tlb_access_sel_thrd0_d1}, {lsu_diagnstc_data_sel[3:0]}, {lsu_diagnstc_va_sel[3:0]}, diag_wr_src_d1, diag_wr_src_d2, diag_wr_src_sel_d1, {ifu_asi_vld_d1,ifu_asi_ack_d1}, ifu_asi_store_cmplt_en_d1, {mbar_inst_m,flsh_inst_m}, {mbar_inst_unflushed,flsh_inst_unflushed}, {mbar_vld0,flsh_vld0}, {mbar_vld1,flsh_vld1}, {mbar_vld2,flsh_vld2}, {mbar_vld3,flsh_vld3}, ackcnt0[3:0], ackcnt1[3:0], ackcnt2[3:0], ackcnt3[3:0], thrid_d[1:0], lsu_tlu_thrid_d[1:0], thrid_e[1:0], thrid_m[1:0], thrid_g[1:0], thrid_w2[1:0], thrid_w3[1:0], ifu_nontlb_asi_tid[1:0], {hpv_priv_d1[3:0],hpstate_en_d1[3:0]}, {hpv_priv_m,hpstate_en_m}, cam_real_m, lsu_tlu_ctxt_sel_m[2:0], dva_vld_g[3:0], {dtag_error_m,dcache_error_m}, {dtag_error_g,dcache_error_g}, {dtag_error_w2,dcache_error_w2}, {l2_unc_error_m,l2_corr_error_m}, {l2_unc_error_g,l2_corr_error_g}, {l2_unc_error_w2,l2_corr_error_w2}, {unc_err_trap_m}, {unc_err_trap_g}, {dfill_tid_m[1:0]}, {dfill_tid_g[1:0]}, {ld_inst_vld_w2,fp_ldst_w2}, {ld_stb_full_raw_w3,ld_inst_vld_w3}, {fp_ldst_thrd0_w3,fp_ldst_thrd1_w3,fp_ldst_thrd2_w3,fp_ldst_thrd3_w3}, {fp_ldst_thrd0_w4,fp_ldst_thrd1_w4,fp_ldst_thrd2_w4,fp_ldst_thrd3_w4}, {fp_ldst_thrd0_w5,fp_ldst_thrd1_w5,fp_ldst_thrd2_w5,fp_ldst_thrd3_w5}, {tte_data_perror_unc_w2,asi_tte_data_perror_w2,asi_tte_tag_perror_w2}, ldbyp0_vld_tmp, rw_index_d1[5:0], {ldbyp0_fpld,spubyp0_trap,misc_data0[6:0]}, {cam_perr_unc0,pend_atm_ld_ue[0],asi_data_perr0,asi_tag_perr0,
ifu_unc_err0}, ldbyp1_vld_tmp, {ldbyp1_fpld,spubyp1_trap,misc_data1[6:0]}, {cam_perr_unc1,pend_atm_ld_ue[1],asi_data_perr1,asi_tag_perr1,
ifu_unc_err1}, ldbyp2_vld_tmp, {ldbyp2_fpld,spubyp2_trap,misc_data2[6:0]}, {cam_perr_unc2,pend_atm_ld_ue[2],asi_data_perr2,asi_tag_perr2,
ifu_unc_err2}, ldbyp3_vld_tmp, {ldbyp3_fpld,spubyp3_trap,misc_data3[6:0]}, {cam_perr_unc3,pend_atm_ld_ue[3],asi_data_perr3,asi_tag_perr3,
ifu_unc_err3}, squash_byp_cmplt_m[3:0], squash_byp_cmplt_g[3:0], intld_byp_data_vld_m, spubyp_trap_active_m, spubyp_trap_active_g, {l2fill_vld_m,l2fill_fpld_m}, {l2fill_vld_g,l2fill_fpld_g}, ldxa_illgl_va_cmplt_d1[3:0], {fraw_annul3_d1,fraw_annul2_d1,fraw_annul1_d1,fraw_annul0_d1}, {ldst_miss3_d1,ldst_miss2_d1,ldst_miss1_d1,ldst_miss0_d1}, lmq_byp_data_raw_sel_d1[3:0], lmq_byp_data_raw_sel_d2[3:0], ld_thrd_byp_sel_m[3:0], ld_thrd_byp_sel_g[3:0], {cam_perr_unc_m,asi_data_perr_m,
asi_tag_perr_m,ifu_unc_err_m,atm_st_unc_err_m}, {cam_perr_unc_g,asi_data_perr_g,
asi_tag_perr_g,ifu_unc_err_g,atm_st_unc_err_g}, {nceen_g,nceen_dfq_g}, atm_ld_w_uerr_m, pmem_unc_error_tmp, async_ttype_g[6:0], async_err_tid_m[1:0], async_err_tid_g[1:0], {lsu_tlu_async_ttype_vld_w2,lsu_tlu_async_tid_w2[1:0],
lsu_tlu_async_ttype_w2[6:0]}, memref_g, lsu_ifu_error_tid[1:0], stxa_internal_d1, stxa_internal_d2, lfsr_incr_d1, {ldst_dbl_m,ld_pcx_pkt_vld_m,
casa_m,ldstub_m,swap_m}, {ldst_dbl_g,ld_pcx_pkt_vld_g,
casa_g,ldstub_g,swap_g,atomic_g}, {ldd_force_l2access_w2,atomic_w2}, {ldd_force_l2access_w3,atomic_w3}, asi_real_iomem_g, {memref_m,dc_waddr_m[2:0]}, pstate_cle_m, pstate_cle_g, bendian_pred_g, {byte_m,hword_m,word_m,dword_m}, {l1hit_sign_extend_m}, {l1hit_sign_extend_g}, {byp_word_g}, {asi_internal_e,primary_asi_e,secondary_asi_e,nucleus_asi_e,
lendian_asi_e,tlb_byp_asi_e,dcache_byp_asi_e,nofault_asi_e,
tlb_lng_ltncy_asi_e,as_if_user_asi_e,atomic_asi_e,blk_asi_e,
dc_diagnstc_asi_e,dtagv_diagnstc_asi_e,
wr_only_asi_e,rd_only_asi_e,mmu_rd_only_asi_e,unimp_asi_e,dmmu_asi58_e,immu_asi50_e,quad_asi_e,binit_quad_asi_e,
ifu_nontlb_asi_e,recognized_asi_e,ifill_tlb_asi_e,
dfill_tlb_asi_e,rd_only_ltlb_asi_e,wr_only_ltlb_asi_e,phy_use_ec_asi_e,phy_byp_ec_asi_e,intrpt_disp_asi_e}, {asi_internal_m,dcache_byp_asi_m,nofault_asi_m,lendian_asi_m,tlb_lng_ltncy_asi_m,
as_if_user_asi_m,atomic_asi_m,blk_asi_m,dc_diagnstc_asi_m,dtagv_diagnstc_asi_m,
wr_only_asi_m,rd_only_asi_m,mmu_rd_only_asi_m,unimp_asi_tmp,dmmu_asi58_m,immu_asi50_m,quad_asi_m,binit_quad_asi_m,recognized_asi_tmp,
ifu_nontlb_asi_m,phy_use_ec_asi_m,phy_byp_ec_asi_m,intrpt_disp_asi_m}, {asi_internal_g,dcache_byp_asi_g,lendian_asi_g,tlb_lng_ltncy_asi_g,
blk_asi_g,dc_diagnstc_asi_g,dtagv_diagnstc_asi_g,quad_asi_g,
binit_quad_asi_g,recognized_asi_g,ifu_nontlb_asi_g,intrpt_disp_asi_g}, {st_sz_hw_g,st_sz_w_g,st_sz_dw_g,stdbl_g}, blkst_m_tmp, blkst_g, snap_blk_st_g, {bst_swap_sel_default_g,bst_swap_sel_default_byte_7_2_g,bst_st_hw_le_g,
bst_st_w_or_dbl_le_g,bst_st_x_le_g}, blkst_pgnum_m[39:10], lsu_pref_pcx_req_d1, pref_ackcnt0[3:0], pref_ackcnt1[3:0], pref_ackcnt2[3:0], pref_ackcnt3[3:0], {lmq_pcx_pkt_addr[10:0]}, {lmq_ldd_vld}, lsu_l2fill_fpld_e, lsu_ncache_ld_e, {lmq_ldfill_way[1:0]}, {lmq_ld_rq_type_e[2:0]}, {lsu_byp_misc_addr_m[2:0],lsu_byp_misc_sz_m[1:0]}}),
		.dump_en(dump_en), 
