...
,
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[10]),   // [SHADOW]
		.ch_out(inst_ch_out[10]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[10]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[10]) // [SHADOW]
); // Templated
...
,
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[11]),   // [SHADOW]
		.ch_out(inst_ch_out[11]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[11]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[11]) // [SHADOW]
);
...
,
		...
		.sh_rst(sh_rst),   // [SHADOW]
		.c_en(c_en),   // [SHADOW]
		.dump_en(ch_dump_en[12]),   // [SHADOW]
		.ch_out(inst_ch_out[12]),   // [SHADOW]
		.ch_out_done(inst_ch_out_done[12]),    // [SHADOW]
		.ch_out_vld(inst_ch_out_vld[12]) // [SHADOW]
);
