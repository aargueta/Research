...
assign all_thrd_force_vld[3]  =  
	...
	shadow_capture #(.DFF_BITS(334), .USE_DCLK(1), .CHAINS_IN(9), .CHAINS_OUT(1), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd334})) shadow_capture_lsu_qctl1 (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({dbb_reset_l, ld_way_mx2_w2[1:0], lmq0_pcx_pkt_way_tmp[1:0], lmq1_pcx_pkt_way_tmp[1:0], lmq2_pcx_pkt_way_tmp[1:0], lmq3_pcx_pkt_way_tmp[1:0], qword_access0, qword_access1, qword_access2, qword_access3, lsu_dfq_byp_tid_d1_sel_tmp[3:0], thrid_m[1:0], thrid_g[1:0], lsu_inst_vld_tmp, {ld_sec_hit_thrd0_w2,ld_sec_hit_thrd1_w2,ld_sec_hit_thrd2_w2,ld_sec_hit_thrd3_w2}, lsu_lmq_byp_misc_sel_tmp[3:0], {ld0_inst_vld_m,ld1_inst_vld_m,
ld2_inst_vld_m,ld3_inst_vld_m,ldst_fp_m,
ldst_dbl_m}, {ldst_va_g[7:6],ld0_inst_vld_unflushed,ld1_inst_vld_unflushed,

ld2_inst_vld_unflushed,ld3_inst_vld_unflushed,

ldst_fp_g,ldst_dbl_g}, {ld0_inst_vld_w2,ld1_inst_vld_w2,ld2_inst_vld_w2,ld3_inst_vld_w2}, {thread0_m,thread1_m,thread2_m,thread3_m}, {thread0_g,thread1_g,thread2_g,thread3_g}, {thread0_w2,thread1_w2,thread2_w2,thread3_w2}, ifu_destid_d[2:0], fpst_vld_g, fpop_pkt_vld_unmasked, fpop_atom_rq_pq, strm_pcx_rq_sel_d2, spu_ack_d1, strm_l2bnk_addr[1:0], strm_pkt_vld_unmasked, {stb0_rqtype[2:1],stb0_rqaddr[2:0]}, {stb1_rqtype[2:1],stb1_rqaddr[2:0]}, {stb2_rqtype[2:1],stb2_rqaddr[2:0]}, {stb3_rqtype[2:1],stb3_rqaddr[2:0]}, {stb3_rd_for_pcx_tmp,stb2_rd_for_pcx_tmp,stb1_rd_for_pcx_tmp,stb0_rd_for_pcx_tmp}, blk_asi_g, bld_helper_cmplt_m, bld_helper_cmplt_g, alt_space_m, alt_space_g, alt_space_w2, bld_w2, bld_thrd_dout[1:0], {bld_cnt[1:0],bld_dout_tmp}, bld_annul_d1[3:0], bld_rd_dout_m[2:0], bld_rd_dout[2:0], {lsu_bld_rq_addr[1:0]}, pref_inst_m, pref_inst_g, lsu_tlu_dcache_miss_w2[3:0], ldquad_inst_g, {full_raw_w2,partial_raw_w2,stb_cam_mhit_w2,ldq_hit_w2,io_ld_w2,
stb_not_empty_w2}, {

pref_rq_vld0_w2,pref_rq_vld1_w2,pref_rq_vld2_w2,pref_rq_vld3_w2,
non_l2bnk_w2,
ldst_va_w2[7:6]}, {atomic_w2,dbl_force_l2access_w2}, perr_ld_rq_kill_w2, asi_internal_g, asi_internal_w2, {ld0_pkt_vld_unmasked,pref_rq_vld0}, atomic_or_ldxa_internal_rq_g, ld0_spec_pick_vld_w2, {ld0_fill_reset_d1,ld1_fill_reset_d1,ld2_fill_reset_d1,ld3_fill_reset_d1}, {ld0_fill_reset_d2_tmp,ld1_fill_reset_d2_tmp,ld2_fill_reset_d2_tmp,ld3_fill_reset_d2_tmp}, ld0_l2cache_rq_w2_tmp, ld0_unfilled_tmp, ld0_unfilled_wy[1:0], ld0_l2bnk_addr[2:0], non_l2bnk_mx0_d1, {ld1_pkt_vld_unmasked,pref_rq_vld1}, ld1_spec_pick_vld_w2, ld1_l2cache_rq_w2_tmp, ld1_unfilled_tmp, ld1_unfilled_wy[1:0], ld1_l2bnk_addr[2:0], non_l2bnk_mx1_d1, {ld2_pkt_vld_unmasked,pref_rq_vld2}, ld2_spec_pick_vld_w2, ld2_l2cache_rq_w2_tmp, ld2_unfilled_tmp, ld2_unfilled_wy[1:0], ld2_l2bnk_addr[2:0], non_l2bnk_mx2_d1, {ld3_pkt_vld_unmasked,pref_rq_vld3}, ld3_spec_pick_vld_w2, ld3_l2cache_rq_w2_tmp, ld3_unfilled_tmp, ld3_unfilled_wy[1:0], ld3_l2bnk_addr[2:0], non_l2bnk_mx3_d1, casa_m, casa_g, pcx_rq_for_stb_d1[3:0], {st3_pcx_rq_sel_d1,st2_pcx_rq_sel_d1,st1_pcx_rq_sel_d1,st0_pcx_rq_sel_d1}, {st3_pcx_rq_sel_d2,st2_pcx_rq_sel_d2,st1_pcx_rq_sel_d2,st0_pcx_rq_sel_d2}, {st3_pcx_rq_sel_d3,st2_pcx_rq_sel_d3,st1_pcx_rq_sel_d3,st0_pcx_rq_sel_d3}, ld0_rawp_disabled, ld0_rawp_ackid[2:0], ld1_rawp_disabled, ld1_rawp_ackid[2:0], ld2_rawp_disabled, ld2_rawp_ackid[2:0], ld3_rawp_disabled, ld3_rawp_ackid[2:0], intrpt_pcx_rq_sel_d2, intrpt_pkt_vld_unmasked, intrpt_clr_d1, lsu_intrpt_cmplt[3:0], intrpt_l2bnk_addr[2:0], lmq_enable_w2[3:0], {st0_atom_rq_d1,st1_atom_rq_d1,st2_atom_rq_d1,st3_atom_rq_d1,
st0_cas_vld_d1,st1_cas_vld_d1,st2_cas_vld_d1,st3_cas_vld_d1}, {st0_atom_rq_d2,st1_atom_rq_d2,st2_atom_rq_d2,st3_atom_rq_d2,
st0_cas_vld_d2,st1_cas_vld_d2,st2_cas_vld_d2,st3_cas_vld_d2}, st_atom_rq_d1, spc_pcx_atom_pq_tmp, {lsu_fwdpkt_vld_d1,fwdpkt_dest_d1[4:0]}, stb_cam_hit_w2, {ld0_pcx_rq_sel_d1,ld1_pcx_rq_sel_d1,ld2_pcx_rq_sel_d1,ld3_pcx_rq_sel_d1}, {ld0_pcx_rq_sel_d2,ld1_pcx_rq_sel_d2,ld2_pcx_rq_sel_d2,ld3_pcx_rq_sel_d2}, lsu_ifu_ld_pcxpkt_vld, dtag_perr_pkt2_vld_d1[3:0], pcx_req_squash_d1, pcx_req_squash_d2, {
imiss_pcx_rq_sel_d1,strm_pcx_rq_sel_d1,intrpt_pcx_rq_sel_d1,fpop_pcx_rq_sel_d1,
fwdpkt_pcx_rq_sel_d1}, imiss_pcx_rq_sel_d2, fwdpkt_pcx_rq_sel_d2, fwdpkt_pcx_rq_sel_d3, fpop_pcx_rq_sel_d2, {st_pcx_rq_sel_d1,ld_pcx_rq_sel_d1}, spc_pcx_req_pq_tmp[4:0], spc_pcx_req_update_w2[4:0], {st3_atomic_pend_d1,st2_atomic_pend_d1,st1_atomic_pend_d1,st0_atomic_pend_d1}, fpop_atomic_pend_d1, mcycle_mask_qwr_d1[4:0], dtag_perror0, dtag_perror1, dtag_perror2, dtag_perror3, ld_thrd_pick_status[3:0], st_thrd_pick_status[3:0], misc_thrd_pick_status[3:0]}),
		.dump_en(dump_en), 
