...
//always->and-or translation end
	...
	shadow_capture #(.DFF_BITS(115), .USE_DCLK(1), .CHAINS_IN(0), .CHAINS_OUT(1), .DISCRETE_DFFS(1), .DFF_WIDTHS({32'd115})) shadow_capture_lsu_stb_ctl (
		.clk(sh_clk), 
		.rst(sh_rst), 
		.capture_en(c_en), 
		.dclk({clk}), 
		.din({stb_ctl_rst_l, {pcx_rq_for_stb_d2,pcx_req_squash_d2}, ffu_bst_wr_g, dtlb_bypass_m, dtlb_bypass_g, tlb_cam_hit_g, {st_pcx_rq_kill_tmp,st_vld_squash_tmp,
any_inflight_iss_w2,pick_inflight_iss_w2,st_dtlb_perr_w2}, stb_rptr_dfq[3:0], {dqptr_d1[7:0],dq_vld_d1}, {dqptr_d2[7:0],dq_vld_d2}, stb_cam_wvld_g, stb_wptr[3:0], dec_wptr_g[7:0], stb_wptr_w2[3:0], stb_full, dec_ackptr[7:0], {stb_alt_sel_g,stb_alt_addr_g[2:0]}, flsh_inst_g, pcx_rq_for_stb_d1, rmo_pend_d1, stb_state_vld_tmp[7:0], stb_state_vld_set_w2[7:0], stb_state_vld_out[7:0], stb_state_ced[7:0], stb_state_ack[7:0], stb_state_io[7:0]}),
		.dump_en(dump_en), 
		.chains_in(), 
		.chains_in_vld(), 
		.chains_in_done(), 
